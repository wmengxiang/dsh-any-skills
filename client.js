...
function SkillsSettingsSection() {
  ...
  const [noticeError, setNoticeError] = (0, import_react.useState)(false);
  ...
  const importTool = (group) => run(async () => {
    ...
    showNotice(t.importedNotice.replace("{n}", String(result.imported.length)) + (result.skipped !== void 0 && result.skipped.length > 0 ? t.skippedSuffix.replace("{n}", String(result.skipped.length)) : ""));
    await refresh();
  });
  ...
  return (0, import_react.createElement)(
    ...
    notice !== void 0 ? (0, import_react.createElement)("div", { className: noticeError ? "dsh-as-fail" : "dsh-as-ok", role: noticeError ? "alert" : "status" }, notice) : null,
